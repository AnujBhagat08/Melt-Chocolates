      ...
      <div className="flex justify-center items-start gap-6">
        ...
        <div>
          <img
            ...
            alt="Cocoa"
            className="relative z-10 cocoa-choco max-w-72.5 max-md:max-w-[45vw] max-md:mx-auto drop-shadow-[0_10px_40px_rgba(72,156,211,0.5)]"
          />
        </div>
        <div>
          <img
            ...
            alt="Orange"
            className="relative z-10 orange-choco max-w-72.5 max-md:max-w-[45vw] max-md:mx-auto drop-shadow-[0_10px_40px_rgba(253,211,38,0.5)]"
          />
        </div>
        <div className="relative">
          <img
            ...
            alt="Almond"
            className="relative z-10 almond-choco max-w-72.5 max-md:max-w-[45vw] max-md:mx-auto mt-18 drop-shadow-[0_10px_40px_rgba(157,156,61,0.5)]"
          />
          <img
            src={Stamp}
            alt="Stamp"
            className="stamp absolute z-10 max-w-37.5 -top-10 -left-20 transform rotate-32 max-md:relative max-md:top-auto max-md:left-auto max-md:mx-auto max-md:mt-10"
          />
        </div>
      </div>
    </>
